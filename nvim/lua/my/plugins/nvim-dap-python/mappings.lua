...
local register_mappings = function()
    map("n", "<LocalLeader>dm", function() require("dap-python").test_method({}) end, { desc = "Test method" })
    map("n", "<LocalLeader>dc", function() require("dap-python").test_class({}) end, { desc = "Test class" })
