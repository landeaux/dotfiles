...
g.nvim_tree_hide_dotfiles = 1 -- hides files and folders starting with a dot `.`
...
g.nvim_tree_lsp_diagnostics = 1 -- show lsp diagnostics in the signcolumn. See :help nvim_tree_lsp_diagnostics.
